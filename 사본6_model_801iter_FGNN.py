...
class FGNN(nn.Module):
    def __init__(self, in_features, out_features, ring_width, max_neigh, h, w):
...
class GNN(nn.Module):
    def __init__(self, in_features, out_features, ring_width, max_neigh, h, w):
        ...
        module_list = [FGNN(in_features, out_features, ring_width, max_neigh, h, w),
                       ReLU(),
                       FGNN(out_features, out_features, ring_width, max_neigh, h, w),
                       ReLU(),
                       FGNN(out_features, out_features, ring_width, max_neigh, h, w)]
