...
class FGNN(nn.Module):
    def __init__(self, in_features, out_features, max_neigh, index_list):
...
class GNN(nn.Module):
    def __init__(self, in_features, out_features, max_neigh, index_list, w_h):
        ...
        module_list = [FGNN(in_features, out_features, max_neigh, index_list),
                       ReLU(),
                       FGNN(out_features, out_features, max_neigh, index_list),
                       ReLU(),
                       FGNN(out_features, out_features, max_neigh, index_list)]
