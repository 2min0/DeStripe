...
def preprocessing(opt):
    ...
    for i in range(img_3D.shape[0]):
        ...
        img = img_3D[i]
        # To normalize, divided by w_h*w_h
    ...
    io.imsave(f'{opt.output_path}/{img_name}.tif', output)


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--input_path', type=str, default='./dataset/2frame_square_fft.tif')
